...
try {
    ...
    <th scope="col">Gestão</th><th scope="col">E-mail</th><th>Funções</th></tr>';
    while ($result = $stmt->fetch((PDO::FETCH_OBJ))) {
        ...
        <td> $result->gestao </td>
        <td> $result->email </td>
        <td> <a href='atualizar.php?id=$result->id'> Alterar </a> </td></tr>";
    } 
    echo '<tr > <td colspan="6";> <a href="index.php"> Voltar </a> </td> </tr>
    </table>
    </div>';
