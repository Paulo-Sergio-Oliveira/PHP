...
<?php
    ...
    //Concatenar
    echo "O meu nome é $nome. <br> Tenho $idade anos. <br> Sempre dou uma volta no meu $veiculo que é uma ".$$veiculo.".";
    ...
    var_dump($vetor); //Debug Completo
    print_r($vetor); //Transforma em String e Imprime
    echo "<br> $vetor[1]";
